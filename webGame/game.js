...
function removeDio(e) {
  ...
  myGameArea.x = e.changedTouches[0].clientX;
  myGameArea.y = e.changedTouches[0].clientY;
  console.log(
...
function finalScene() {
  ...
  jotaroDialog = new component(
    ...
    100,
    "img/dialog_J.png",
    (shift + gamecanvasWidth) / 2 - size / 2 - 25,
  ...
  kalyoinDialog = new component(
    ...
    100,
    "img/dialog_K.png",
    (shift + gamecanvasWidth) - 150,
    (gamecanvasHeight - 110 - size) - 110,
    "image",
    0,
    0
  );
